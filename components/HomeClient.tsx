  ...
  return <main>
    <section className="hero heroReference">
      ...
      <div className="heroVisual" aria-hidden="true">
        <motion.img className="heroPhotoCutout" src="/photos/hero.jpg" alt="" initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .7, delay: .08, ease: [0.22, 1, 0.36, 1] }}/>
    ...
    <style jsx global>{`
      ...
      .heroReference .heroVisual{position:absolute;inset:0;z-index:2;height:754px;pointer-events:none}.heroReference .heroPhotoCutout{position:absolute;z-index:2;left:68.1%;bottom:-8px;width:610px;height:610px;max-width:none;transform:translateX(-50%);object-fit:cover;object-position:center top;filter:saturate(.92) contrast(1.01);border-radius:0;mask-image:linear-gradient(to bottom,#000 0,#000 78%,transparent 100%);-webkit-mask-image:linear-gradient(to bottom,#000 0,#000 78%,transparent 100%)}.heroReference .heroVisual::after{content:"";position:absolute;z-index:3;left:47%;right:2%;bottom:-1px;height:94px;background:linear-gradient(to bottom,transparent,rgba(255,255,255,.99));pointer-events:none}
