...
export default function PromptLibraryPage(){return <main className="page resourceDetail">
  ...
  <section className="resourceHero promptLibraryHero">
  ...
  <section className="studioLibrary promptLibrarySection">
    <div className="sectionHead"><div><span className="eyebrow">PROMPTS</span><h2>Choose what you need.</h2><p>Each prompt includes a clear purpose, the full prompt, a copy action, a downloadable Markdown file and a brief usage guide.</p></div></div>
